...
export const INSTRUCTION_TABLE: { [opcode: number]: IInstruction } = {
    ...
    0x10: new Instruction(0x10, 'BPL', 'Relative', 2, 2),
    ...
    0x30: new Instruction(0x30, 'BMI', 'Relative', 2, 2),
    ...
    0x50: new Instruction(0x50, 'BVC', 'Relative', 2, 2),
    ...
    0x70: new Instruction(0x70, 'BVS', 'Relative', 2, 2),
    ...
    0x90: new Instruction(0x90, 'BCC', 'Relative', 2, 2),
    ...
    0xb0: new Instruction(0xb0, 'BCS', 'Relative', 2, 2),
    0xb1: new Instruction(0xb1, 'LDA', '(IND),Y', 2, 6),
    // 0xb2: new Instruction(0xb2, 'LDA', '(IND)', 2, 5), - not supported by vanilla 6502
    ...
    0xd0: new Instruction(0xd0, 'BNE', 'Relative', 2, 2),
    ...
    0xf0: new Instruction(0xf0, 'BEQ', 'Relative', 2, 2),
...
export default INSTRUCTION_TABLE
